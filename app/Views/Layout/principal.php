...
<head>
  ...
  <!-- Espaco reservado para renderizar os estilos de cada view que estender esse layout -->
...
<body>
    ...
    <div class="page-content">
      <div class="page-header">
        <div class="container-fluid">
          <h2 class="h3 no-margin-bottom"><?= $titulo; ?></h2>
        </div>
      </div>
      ...
      <section class="no-padding-top no-padding-bottom">
        ...
        <!-- Espaco reservado para renderizar o conteudo de cada view que estender esse layout -->
        <div class="container-fluid">

          <!-- Retorno de mensagens Flash -->
          <?php echo $this->include('Layout/_mensagens'); ?>

          <!-- Espaco reservado para renderizar o conteudo que estender a pagina mentra -->
  ...
  <!-- Espaco reservado para renderizar os scripts de cada view que estender esse layout -->
